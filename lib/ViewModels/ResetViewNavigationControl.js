 ...
 */
define('ResetViewNavigationControl', ['inherit', 'NavigationControl', 'svgReset'], function (inherit, NavigationControl, svgReset)
{
    ...
    ResetViewNavigationControl.prototype.resetView = function () {
        ...
        //this.terria.flyTo({'destination': this.terria.homeView.rectangle, 'duration': 1});
        this.terria.scene.camera.flyTo({'destination': this.terria.homeView.rectangle, 'duration': 1});
